...
mockAxios.onPost(ACCOUNT_API_PATH.GET_ACCOUNT_SESSION).reply(200, {
  account: {
    ...
    picture:
      'https://lh3.googleusercontent.com/ogw/AF2bZygl_79h9ZThodhkjkXrPAKsCFdJDJ6H825TOnnXEyJI5u0=s32-c-mo',
    id: '1234',
  },
});
...
mockAxios.onPost(OFFER_API_PATH.SEARCH_AGGREGATED_COMPANY_STATS_LIST).reply(200, {
  company_stat_list: [
    {
      company: {
        id: 123,
...
} as SearchAggregatedCompanyStatsListResponse);
...
mockAxios.onPost(OFFER_API_PATH.CREATE_OFFER_IMAGE).reply(200, {
  image: {
    id: 1,
    presign_put_url:
      'https://raw.githubusercontent.com/mantinedev/mantine/master/.demo/images/bg-7.png?helloworld',
  },
} as CreateOfferImageResponse);
...
mockAxios.onPost(OFFER_API_PATH.GET_OFFER).reply(200, {
  offer: {
    id: 5,
    company: {
      id: 105,
