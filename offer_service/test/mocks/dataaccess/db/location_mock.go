...
//
//	mockgen -source=./location.go -destination=../../../test/mocks/dataaccess/db/location_mock.go -package=mockdatabase
//
...
func (m *MockLocationAccessor) GetByCountryStateCity(ctx context.Context, country, state, city string) (*database.Location, error) {
	m.ctrl.T.Helper()
...
func (m *MockLocationAccessor) GetByID(ctx context.Context, id uint64) (*database.Location, error) {
	m.ctrl.T.Helper()
