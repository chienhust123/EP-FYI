...
/*
Package offer_core_servicev1 is a reverse proxy.
...
func request_OfferCoreService_UpdateOfferStatus_0(ctx context.Context, marshaler runtime.Marshaler, client OfferCoreServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateOfferStatusRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateOfferStatus(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_OfferCoreService_UpdateOfferStatus_0(ctx context.Context, marshaler runtime.Marshaler, server OfferCoreServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateOfferStatusRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateOfferStatus(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterOfferCoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OfferCoreServiceServer) error {
	...
	mux.Handle("POST", pattern_OfferCoreService_CreateOfferImage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/CreateOfferImage", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/CreateOfferImage"))
		if err != nil {
	...
	mux.Handle("POST", pattern_OfferCoreService_CreateOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/CreateOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/CreateOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OfferCoreService_UpdateOfferStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/UpdateOfferStatus", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/UpdateOfferStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OfferCoreService_UpdateOfferStatus_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_OfferCoreService_UpdateOfferStatus_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_OfferCoreService_GetOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/GetOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/GetOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OfferCoreService_GetOfferList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/GetOfferList", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/GetOfferList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOfferCoreServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OfferCoreServiceClient) error {
	...
	mux.Handle("POST", pattern_OfferCoreService_CreateOfferImage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/CreateOfferImage", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/CreateOfferImage"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OfferCoreService_CreateOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/CreateOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/CreateOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OfferCoreService_UpdateOfferStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/UpdateOfferStatus", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/UpdateOfferStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OfferCoreService_UpdateOfferStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_OfferCoreService_GetOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/GetOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/GetOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OfferCoreService_GetOfferList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/GetOfferList", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/GetOfferList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_OfferCoreService_CreateOfferImage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "CreateOfferImage"}, ""))

	pattern_OfferCoreService_CreateOffer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "CreateOffer"}, ""))

	pattern_OfferCoreService_UpdateOfferStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "UpdateOfferStatus"}, ""))

	pattern_OfferCoreService_GetOffer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "GetOffer"}, ""))

	pattern_OfferCoreService_GetOfferList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "GetOfferList"}, ""))
)
...
var (
	...
	forward_OfferCoreService_UpdateOfferStatus_0 = runtime.ForwardResponseMessage
