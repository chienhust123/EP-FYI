...
func RegisterOfferCoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OfferCoreServiceServer) error {
	...
	mux.Handle("POST", pattern_OfferCoreService_UpdateOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/UpdateOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/UpdateOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOfferCoreServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OfferCoreServiceClient) error {
	...
	mux.Handle("POST", pattern_OfferCoreService_UpdateOffer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/offer_core_service.v1.OfferCoreService/UpdateOffer", runtime.WithHTTPPathPattern("/offer_core_service.v1.OfferCoreService/UpdateOffer"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_OfferCoreService_UpdateOffer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"offer_core_service.v1.OfferCoreService", "UpdateOffer"}, ""))
